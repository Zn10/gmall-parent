...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (0, 1, 'common.yaml', 'DEFAULT_GROUP', '', 'mybatis-plus:\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n  mapper-locations: classpath:mapper/*Mapper.xml\nfeign:\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        readTimeout: 30000\n        connectTimeout: 10000\nspring:\n  zipkin:\n    base-url: http://192.168.200.129:9411\n    discovery-client-enabled: false\n    sender:\n      type: web\n  # cloud:\n  #   sentinel:\n  #     transport:\n  #       dashboard: http://192.168.200.129:8858\n  rabbitmq:\n    host: 192.168.200.129\n    port: 5672\n    username: guest\n    password: guest\n    publisher-confirm-type: correlated\n    publisher-returns: true\n    listener:\n      simple:\n        acknowledge-mode: manual #默认情况下消息消费者是自动确认消息的，如果要手动确认消息则需要修改确认模式为manual\n        prefetch: 1 # 消费者每次从队列获取的消息数量。此属性当不设置时为：轮询分发，设置为1为：公平分发\n  redis:\n    host: 192.168.200.129\n    port: 6379\n    database: 0\n    timeout: 1800000\n    password:\n    lettuce:\n      pool:\n        max-active: 20 #最大连接数\n        max-wait: -1    #最大阻塞等待时间(负数表示没限制)\n        max-idle: 5    #最大空闲\n        min-idle: 0     #最小空闲\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8', '7bf752d402b371d9e7daf435415a32c2', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 2, 'server-gateway-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 80\nspring:\n  redis:\n    host: 192.168.200.129\n    port: 6379\n    database: 0\n    timeout: 1800000\n    password:\n  cloud:\n    gateway:\n      discovery:      #是否与服务发现组件进行结合，通过 serviceId(必须设置成大写) 转发到具体的服务实例。默认为false，设为true便开启通过服务中心的自动根据 serviceId 创建路由的功能。\n        locator:      #路由访问方式：http://Gateway_HOST:Gateway_PORT/大写的serviceId/**，其中微服务应用名默认大写访问。\n          enabled: true\n      routes:\n        - id: service-product\n          uri: lb://service-product\n          predicates:\n            - Path=/*/product/** # 路径匹配\n        - id: service-item\n          uri: lb://service-item\n          predicates:\n            - Path=/*/item/**\n        - id: service-user\n          uri: lb://service-user\n          predicates:\n            - Path=/*/user/**\n        - id: service-cart\n          uri: lb://service-cart\n          predicates:\n            - Path=/*/cart/**\n        - id: service-order\n          uri: lb://service-order\n          predicates:\n            - Path=/*/order/**\n        - id: service-payment\n          uri: lb://service-payment\n          predicates:\n            - Path=/*/payment/**\n        - id: service-activity\n          uri: lb://service-activity\n          predicates:\n            - Path=/*/activity/** # 路径匹配\n        - id: service-comment\n          uri: lb://service-comment\n          predicates:\n            - Path=/*/comment/**\n        #==================web前端==========================\n        - id: web-item\n          uri: lb://web-all\n          predicates:\n            - Host=item.gmall.com\n        #==================首页前端==========================\n        - id: web-index\n          uri: lb://web-all\n          predicates:\n            - Host=www.gmall.com\n        - id: web-list\n          uri: lb://web-all\n          predicates:\n            - Host=list.gmall.com\n        - id: web-passport\n          uri: lb://web-all\n          predicates:\n            - Host=passport.gmall.com\n        - id: web-cart\n          uri: lb://web-all\n          predicates:\n            - Host=cart.gmall.com\n        - id: web-order\n          uri: lb://web-all\n          predicates:\n            - Host=order.gmall.com\n        - id: web-payment\n          uri: lb://web-all\n          predicates:\n            - Host=payment.gmall.com\n        - id: web-activity\n          uri: lb://web-all\n          predicates:\n            - Host=activity.gmall.com\n        - id: web-comment\n          uri: lb://web-all\n          predicates:\n            - Host=comment.gmall.com\nauthUrls:\n  url: trade.html,myOrder.html,#list.html,#addCart.html # 用户访问该控制器的时候，会被拦截跳转到登录！\n', '6b0b2bec24e127449ea8dabcb20a5b89', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 3, 'service-activity-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8200\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_activity?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool', '97d26ff69be9a6f526dc97dd7939d725', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 4, 'service-cart-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8201\n# spring:\n#   datasource:\n#     type: com.zaxxer.hikari.HikariDataSource\n#     driver-class-name: com.mysql.jdbc.Driver\n#     url: jdbc:mysql://localhost:3306/gmall_order?characterEncoding=utf-8&useSSL=false\n#     username: root\n#     password: root\n#     hikari:\n#       connection-test-query: SELECT 1\n#       connection-timeout: 60000\n#       idle-timeout: 500000\n#       max-lifetime: 540000\n#       maximum-pool-size: 12\n#       minimum-idle: 10\n#       pool-name: GuliHikariPool\n', '9ac51021de802686cce22a3a173cc7cb', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 5, 'service-item-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8202', 'bb8505f90d2099a1d5267b0e037cf1a3', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 6, 'service-list-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8203\n\nspring:\n  elasticsearch:\n    rest:\n      uris: http://192.168.200.129:9200', 'a4a6e54f94f867e72872bc67c7d824f9', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 7, 'service-order-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8204\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_order?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\nware:\n  url: http://localhost:9001', 'b34bcc1e5084f9c724ba3a2871b9630f', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 8, 'service-payment-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8205\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_order?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\nalipay_public_key: \nalipay_url: https://openapi.alipay.com/gateway.do\napp_id: 2021001163617452\napp_private_key: \nnotify_payment_url: http://rjsh38.natappfree.cc/api/payment/alipay/callback/notify\nreturn_order_url: http://payment.gmall.com/pay/success.html\nreturn_payment_url: http://api.gmall.com/api/payment/alipay/callback/return\n', 'f2f7293c80635c58561c11d45d45b097', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 9, 'service-product-dev.yaml', 'DEFAULT_GROUP', '', '# server:\n#   port: 8206\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_product?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1 # 自动检测连接\n      connection-timeout: 60000 #数据库连接超时时间,默认30秒\n      idle-timeout: 500000 #空闲连接存活最大时间，默认600000（10分钟）\n      max-lifetime: 540000 #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟\n      maximum-pool-size: 12 #连接池最大连接数，默认是10\n      minimum-idle: 10 #最小空闲连接数量\n      pool-name: SPHHikariPool # 连接池名称\nminio:\n  endpointUrl: http://192.168.200.129:9000\n  accessKey: admin\n  secreKey: admin123456\n  bucketName: gmall\n', 'c3b9c821881027abd4280fa12526598e', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 10, 'service-task-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8207\r\n', 'f63f928c5905b317abec7c22b434f9c9', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 11, 'service-user-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8208\n\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_user?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\n', '450677a9fa7b26942b1ef6e95496fa81', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 12, 'web-all-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8300\r\n\r\nspring:\r\n  thymeleaf:\r\n    mode: LEGACYHTML5\r\n    #编码 可不用配置\r\n    encoding: UTF-8\r\n    #开发配置为false,避免修改模板还要重启服务器\r\n    cache: false\r\n    #配置模板路径，默认是templates，可以不用配置\r\n    prefix: classpath:/templates/\r\n', '63683bfbfac5775737692b3850b78962', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 13, 'service-comment-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8211\nspring:\n  main:\n    allow-bean-definition-overriding: true #当遇到同样名字的时候，是否允许覆盖注册\n  data:\n    mongodb:\n      host: 192.168.200.129\n      port: 27017\n      database: gmall #指定操作的数据库\n  # redis:\n  #   host: 192.168.200.129\n  #   port: 6379\n  #   database: 0\n  #   timeout: 1800000\n  #   password:\n  #   lettuce:\n  #     pool:\n  #       max-active: 20 #最大连接数\n  #       max-wait: -1    #最大阻塞等待时间(负数表示没限制)\n  #       max-idle: 5    #最大空闲\n  #       min-idle: 0     #最小空闲\n  # jackson:\n  #   date-format: yyyy-MM-dd HH:mm:ss\n  #   time-zone: GMT+8', 'c55a785cc7a29a631e0af94ae417c1e8', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 14, 'service-mq-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8282', '8e27892125791fb1cf2acc89acaac3a7', '2024-11-12 17:16:33', '2024-11-12 09:16:33', NULL, '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
INSERT INTO `his_config_info` VALUES (1, 15, 'common.yaml', 'DEFAULT_GROUP', '', 'mybatis-plus:\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n  mapper-locations: classpath:mapper/*Mapper.xml\nfeign:\n  sentinel:\n    enabled: true\n  client:\n    config:\n      default:\n        readTimeout: 30000\n        connectTimeout: 10000\nspring:\n  zipkin:\n    base-url: http://192.168.200.129:9411\n    discovery-client-enabled: false\n    sender:\n      type: web\n  # cloud:\n  #   sentinel:\n  #     transport:\n  #       dashboard: http://192.168.200.129:8858\n  rabbitmq:\n    host: 192.168.200.129\n    port: 5672\n    username: guest\n    password: guest\n    publisher-confirm-type: correlated\n    publisher-returns: true\n    listener:\n      simple:\n        acknowledge-mode: manual #默认情况下消息消费者是自动确认消息的，如果要手动确认消息则需要修改确认模式为manual\n        prefetch: 1 # 消费者每次从队列获取的消息数量。此属性当不设置时为：轮询分发，设置为1为：公平分发\n  redis:\n    host: 192.168.200.129\n    port: 6379\n    database: 0\n    timeout: 1800000\n    password:\n    lettuce:\n      pool:\n        max-active: 20 #最大连接数\n        max-wait: -1    #最大阻塞等待时间(负数表示没限制)\n        max-idle: 5    #最大空闲\n        min-idle: 0     #最小空闲\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8', '7bf752d402b371d9e7daf435415a32c2', '2024-11-12 17:17:46', '2024-11-12 09:17:47', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (2, 16, 'server-gateway-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 80\nspring:\n  redis:\n    host: 192.168.200.129\n    port: 6379\n    database: 0\n    timeout: 1800000\n    password:\n  cloud:\n    gateway:\n      discovery:      #是否与服务发现组件进行结合，通过 serviceId(必须设置成大写) 转发到具体的服务实例。默认为false，设为true便开启通过服务中心的自动根据 serviceId 创建路由的功能。\n        locator:      #路由访问方式：http://Gateway_HOST:Gateway_PORT/大写的serviceId/**，其中微服务应用名默认大写访问。\n          enabled: true\n      routes:\n        - id: service-product\n          uri: lb://service-product\n          predicates:\n            - Path=/*/product/** # 路径匹配\n        - id: service-item\n          uri: lb://service-item\n          predicates:\n            - Path=/*/item/**\n        - id: service-user\n          uri: lb://service-user\n          predicates:\n            - Path=/*/user/**\n        - id: service-cart\n          uri: lb://service-cart\n          predicates:\n            - Path=/*/cart/**\n        - id: service-order\n          uri: lb://service-order\n          predicates:\n            - Path=/*/order/**\n        - id: service-payment\n          uri: lb://service-payment\n          predicates:\n            - Path=/*/payment/**\n        - id: service-activity\n          uri: lb://service-activity\n          predicates:\n            - Path=/*/activity/** # 路径匹配\n        - id: service-comment\n          uri: lb://service-comment\n          predicates:\n            - Path=/*/comment/**\n        #==================web前端==========================\n        - id: web-item\n          uri: lb://web-all\n          predicates:\n            - Host=item.gmall.com\n        #==================首页前端==========================\n        - id: web-index\n          uri: lb://web-all\n          predicates:\n            - Host=www.gmall.com\n        - id: web-list\n          uri: lb://web-all\n          predicates:\n            - Host=list.gmall.com\n        - id: web-passport\n          uri: lb://web-all\n          predicates:\n            - Host=passport.gmall.com\n        - id: web-cart\n          uri: lb://web-all\n          predicates:\n            - Host=cart.gmall.com\n        - id: web-order\n          uri: lb://web-all\n          predicates:\n            - Host=order.gmall.com\n        - id: web-payment\n          uri: lb://web-all\n          predicates:\n            - Host=payment.gmall.com\n        - id: web-activity\n          uri: lb://web-all\n          predicates:\n            - Host=activity.gmall.com\n        - id: web-comment\n          uri: lb://web-all\n          predicates:\n            - Host=comment.gmall.com\nauthUrls:\n  url: trade.html,myOrder.html,#list.html,#addCart.html # 用户访问该控制器的时候，会被拦截跳转到登录！\n', '6b0b2bec24e127449ea8dabcb20a5b89', '2024-11-12 17:18:04', '2024-11-12 09:18:04', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (3, 17, 'service-activity-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8200\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_activity?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool', '97d26ff69be9a6f526dc97dd7939d725', '2024-11-12 17:18:20', '2024-11-12 09:18:21', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (6, 18, 'service-list-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8203\n\nspring:\n  elasticsearch:\n    rest:\n      uris: http://192.168.200.129:9200', 'a4a6e54f94f867e72872bc67c7d824f9', '2024-11-12 17:18:42', '2024-11-12 09:18:43', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (7, 19, 'service-order-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8204\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_order?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\nware:\n  url: http://localhost:9001', 'b34bcc1e5084f9c724ba3a2871b9630f', '2024-11-12 17:19:02', '2024-11-12 09:19:03', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (8, 20, 'service-payment-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8205\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_order?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\nalipay_public_key: \nalipay_url: https://openapi.alipay.com/gateway.do\napp_id: 2021001163617452\napp_private_key: \nnotify_payment_url: http://rjsh38.natappfree.cc/api/payment/alipay/callback/notify\nreturn_order_url: http://payment.gmall.com/pay/success.html\nreturn_payment_url: http://api.gmall.com/api/payment/alipay/callback/return\n', 'f2f7293c80635c58561c11d45d45b097', '2024-11-12 17:19:20', '2024-11-12 09:19:20', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (9, 21, 'service-product-dev.yaml', 'DEFAULT_GROUP', '', '# server:\n#   port: 8206\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_product?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1 # 自动检测连接\n      connection-timeout: 60000 #数据库连接超时时间,默认30秒\n      idle-timeout: 500000 #空闲连接存活最大时间，默认600000（10分钟）\n      max-lifetime: 540000 #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟\n      maximum-pool-size: 12 #连接池最大连接数，默认是10\n      minimum-idle: 10 #最小空闲连接数量\n      pool-name: SPHHikariPool # 连接池名称\nminio:\n  endpointUrl: http://192.168.200.129:9000\n  accessKey: admin\n  secreKey: admin123456\n  bucketName: gmall\n', 'c3b9c821881027abd4280fa12526598e', '2024-11-12 17:19:45', '2024-11-12 09:19:46', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (11, 22, 'service-user-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8208\n\nspring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource\n    driver-class-name: com.mysql.jdbc.Driver\n    url: jdbc:mysql://192.168.200.129:3306/gmall_user?characterEncoding=utf-8&useSSL=false\n    username: root\n    password: root\n    hikari:\n      connection-test-query: SELECT 1\n      connection-timeout: 60000\n      idle-timeout: 500000\n      max-lifetime: 540000\n      maximum-pool-size: 12\n      minimum-idle: 10\n      pool-name: GuliHikariPool\n', '450677a9fa7b26942b1ef6e95496fa81', '2024-11-12 17:20:07', '2024-11-12 09:20:08', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (13, 23, 'service-comment-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8211\nspring:\n  main:\n    allow-bean-definition-overriding: true #当遇到同样名字的时候，是否允许覆盖注册\n  data:\n    mongodb:\n      host: 192.168.200.129\n      port: 27017\n      database: gmall #指定操作的数据库\n  # redis:\n  #   host: 192.168.200.129\n  #   port: 6379\n  #   database: 0\n  #   timeout: 1800000\n  #   password:\n  #   lettuce:\n  #     pool:\n  #       max-active: 20 #最大连接数\n  #       max-wait: -1    #最大阻塞等待时间(负数表示没限制)\n  #       max-idle: 5    #最大空闲\n  #       min-idle: 0     #最小空闲\n  # jackson:\n  #   date-format: yyyy-MM-dd HH:mm:ss\n  #   time-zone: GMT+8', 'c55a785cc7a29a631e0af94ae417c1e8', '2024-11-12 17:20:38', '2024-11-12 09:20:39', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (13, 24, 'service-comment-dev.yaml', 'DEFAULT_GROUP', '', 'server:\n  port: 8211\nspring:\n  main:\n    allow-bean-definition-overriding: true #当遇到同样名字的时候，是否允许覆盖注册\n  data:\n    mongodb:\n      host: gmal-mongdb\n      port: 27017\n      database: gmall #指定操作的数据库\n  # redis:\n  #   host: 192.168.200.129\n  #   port: 6379\n  #   database: 0\n  #   timeout: 1800000\n  #   password:\n  #   lettuce:\n  #     pool:\n  #       max-active: 20 #最大连接数\n  #       max-wait: -1    #最大阻塞等待时间(负数表示没限制)\n  #       max-idle: 5    #最大空闲\n  #       min-idle: 0     #最小空闲\n  # jackson:\n  #   date-format: yyyy-MM-dd HH:mm:ss\n  #   time-zone: GMT+8', 'a612d354e6caa09956750f9cf4707164', '2024-11-12 17:20:46', '2024-11-12 09:20:47', 'nacos', '0:0:0:0:0:0:0:1', 'U', 'gmall', '');
INSERT INTO `his_config_info` VALUES (0, 25, 'service-ware-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 9001\r\n\r\nmybatis-plus:\r\n  configuration:\r\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\r\n  mapper-locations: classpath:com/atguigu/gmall/*/mapper/*.xml\r\n\r\nspring:\r\n  thymeleaf:\r\n    #模板的模式，支持 HTML, XML TEXT JAVASCRIPT\r\n    mode: HTML5\r\n    #编码 可不用配置\r\n    encoding: UTF-8\r\n    #开发配置为false,避免修改模板还要重启服务器\r\n    cache: false\r\n    #配置模板路径，默认是templates，可以不用配置\r\n    prefix: classpath:/templates/\r\n  rabbitmq:\r\n    host: gmall-rabbitmq\r\n    port: 5672\r\n    username: guest\r\n    password: guest\r\n    publisher-confirms: true\r\n    publisher-returns: true\r\n    listener:\r\n      simple:\r\n        cknowledge-mode: manual\r\n        prefetch: 1 # 消费者每次从队列获取的消息数量。此属性当不设置时为：轮询分发，设置为1为：公平分发\r\n  redis:\r\n    host: gmall-redis\r\n    port: 6379\r\n    database: 0\r\n    timeout: 1800000\r\n    password:\r\n    lettuce:\r\n      pool:\r\n        max-active: 20 #最大连接数\r\n        max-wait: -1    #最大阻塞等待时间(负数表示没限制)\r\n        max-idle: 5    #最大空闲\r\n        min-idle: 0     #最小空闲\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.jdbc.Driver\r\n    url: jdbc:mysql://gmall-mysql:3306/gmall_ware?characterEncoding=utf-8&useSSL=false\r\n    username: root\r\n    password: root\r\n    hikari:\r\n      connection-test-query: SELECT 1\r\n      connection-timeout: 60000\r\n      idle-timeout: 500000\r\n      max-lifetime: 540000\r\n      maximum-pool-size: 12\r\n      minimum-idle: 10\r\n      pool-name: GuliHikariPool\r\n  jackson:\r\n    date-format: yyyy-MM-dd HH:mm:ss\r\n    time-zone: GMT+8\r\n\r\norder:\r\n  split:\r\n    url: http://localhost:8204/api/order/orderSplit', '344aad9c523607806bd8fd7e9371237b', '2024-11-12 17:23:17', '2024-11-12 09:23:17', 'nacos', '0:0:0:0:0:0:0:1', 'I', 'gmall', '');
